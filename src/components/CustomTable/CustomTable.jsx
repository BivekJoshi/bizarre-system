...
//           return (
//             <Box
//               sx={{ display: "flex", justifyContent: "flex-end", gap: "0rem" }}
//             >
//               {props.edit && (
...
//                   <IconButton color="error" onClick={() => handleSwicth(row)}>
//                     <Delete />
//                   </IconButton>
//                 </Tooltip>
//               )}
...
//           sx: {
//             backgroundColor:
//               props?.headerBackgroundColor || theme.palette.secondary.light,
//             color:
//               props?.headerColor ||
//               (theme?.palette?.mode === "light" ? "#ffff" : "black"),
...
//               (theme?.palette?.mode === "dark" ? "black" : "#ffff"),
//           },
//         }}
