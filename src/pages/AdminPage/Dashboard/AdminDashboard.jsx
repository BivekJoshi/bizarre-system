    ...
    <Box sx={{ p: { xs: 1, md: 2 }, maxWidth: "1600px", margin: "0 auto" }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Welcome back! Here's a real-time snapshot of your restaurant's performance.
        </Typography>
      </Box>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
            ...
            <Box sx={{ height: 350, width: "100%" }}>
              {salesData.length > 0 ? (
                ...
                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%" }}>
                  <Typography color="text.secondary" variant="body2">No sales data available</Typography>
                </Box>
              )}
            </Box>
          </Card>
        ...
        <Grid item xs={12} lg={4}>
          ...
          >
            <Typography variant="h6" fontWeight={700} sx={{ mb: 2 }}>Top Items Sold</Typography>
            <List disablePadding>
              {reportData?.topSoldItems?.map((item, index) => (
                ...
                >
                  <Avatar
                    sx={{
                      mr: 2,
                      bgcolor: index === 0 ? "#fbbf24" : index === 1 ? "#94a3b8" : index === 2 ? "#d97706" : "primary.main",
                      width: 32,
                      height: 32,
                    }}
                  >
                  ...
                  <ListItemText
                    primary={<Typography variant="body2" fontWeight={600}>{item.itemName}</Typography>}
              ...
              {(!reportData?.topSoldItems || reportData.topSoldItems.length === 0) && (
          ...
          <Grid item xs={12}>
            <Card
              sx={{
                ...
                border: isDark ? "1px solid rgba(146, 64, 14, 0.2)" : "1px solid #fde68a",
              }}
            >
              <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 1.5 }}>
                <Typography variant="h5">🎉</Typography>
                <Box>
                  <Typography variant="h6" fontWeight={800} color={isDark ? "#fbbf24" : "#92400e"}>
