...
import { useUploadItemImageForm } from "../../hooks/item/useItem";

const ImageSelectionUpload = ({ selectedImage, isUploaded, rowDataId }) => {
  ...
  const { formik } = useUploadItemImageForm({
    finalImageFile,
    rowDataId,
  });
...
export default ImageSelectionUpload;
