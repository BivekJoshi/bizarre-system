    ...
    >
      <CardContent sx={{ p: 3, flexGrow: 1, display: "flex", flexDirection: "column" }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, mb: 3 }}>
          ...
          <Typography variant="h5" fontWeight={700}>Product Generator</Typography>
        </Box>
          ...
          {isLoading ? (
            ...
            >
              ...
              <Grid container spacing={2} sx={{ mb: 2 }}>
                <Grid item xs={4}>
                  ...
                  <Typography variant="body2" fontWeight={700}>Rs {generateItemData?.costPrice}</Typography>
                </Grid>
                <Grid item xs={4}>
                  <Typography variant="caption" color="text.secondary" display="block">Marked</Typography>
                  <Typography variant="body2" fontWeight={700}>Rs {generateItemData?.markedPrice}</Typography>
                </Grid>
                <Grid item xs={4}>
                  <Typography variant="caption" color="text.secondary" display="block">Selling</Typography>
                  <Typography variant="body2" fontWeight={700} color="success.main">Rs {generateItemData?.sellingPrice}</Typography>
                </Grid>
              </Grid>

              <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1, mb: 2 }}>
                <Chip label={generateItemData?.type} size="small" sx={{ fontWeight: 600 }} />
            ...
            >
              <Typography color="text.secondary" align="center" variant="body2">
                Describe a product (e.g., "A spicy Italian pasta with fresh basil") and let AI generate the details for you!
              </Typography>
            </Box>
          )}
        </Box>
